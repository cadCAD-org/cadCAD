from typing import TypedDict, Callable, Union, Dict, List, Tuple, Iterator, Mapping
from collections import deque

State = Dict[str, object]


ParameterSingle = object
ParameterSweep = List[object]
...
StateUpdateTuple = Tuple[str, object]
