...
***IMPORTANT NOTE:*** Tokens are issued and to be used by trial users and BlockScience employees **ONLY**. Please replace <TOKEN> with and issued token in the script below.
```bash
